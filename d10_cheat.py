...
print("I'm Bot " + str(wanted_bot) + ", and I'm responsible for microchips 17 and 61.")
print('....')
print("Outputs zero, one, and two have values: " + str(a) + ', ' + str(b) + ', and ' + str(c) + ".")
sum = a*b*c
print("Did you know that if you multiply them, you get " + str(sum) + "?")