...
print("By my calculation, it should take no more than " + str(first_solution) + " steps.")
print('....')
print("Even if there were two more elements, it should be " + str(second_solution) + " steps total.")